...
void btCollisionWorld::debugDrawObject(const btTransform& worldTransform, const btCollisionShape* shape, const btVector3& color)
{
	...
	} else
	{
        ...
        case STATIC_PLANE_PROXYTYPE:
            ...
            //NOTE addition for tableflip engine - icetooth
        case CONVEX_2D_SHAPE_PROXYTYPE:
        {
            //basically the below Polyhedral draw
            btPolyhedralConvexShape* polyshape =  ((btPolyhedralConvexShape*)((CollisionShape *)shape->getUserPointer())->shape2dProxy);
